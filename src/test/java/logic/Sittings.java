...
public class Sittings extends WeekEvent{
    ...
    public Sittings(AndroidDriver<MobileElement> driver) {
        super(driver);
        this.driver=driver;
    ...
    public void clickOnFirstDayOfTheWeek() {
        ...
        MobileElement firstDayOfTheWeek = driver.findElement(MobileBy.xpath(FIRST_DAY_OF_THE_WEEK_BUTTON));
